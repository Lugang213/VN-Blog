<template>
	<div class = "msgboard">
		...
		<div class="leavemsg">
			<h2 >所有留言：</h2>
			<ul>
				<li v-for = "item in msgBoardArr" class = "board-item" :key="item">
					...
					<div class = "admin-reply">
						<ul  v-if = "item.reply.length !== 0">
							<li v-for = "rep in item.reply" class = "board-reply-item" :key="rep">
...
<script>
	...
	// import emoji from "@/components/front/emoji"
